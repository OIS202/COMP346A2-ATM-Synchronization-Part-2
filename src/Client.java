...
//        	 }
            ...
            //System.out.println("\n DEBUG : Client.receiveTransactions() "+ i +" - receiving updated transaction on account " + transact.getAccountNumber());
    ...
    {   
    	...
    	long sendClientStartTime, sendClientEndTime, receiveClientStartTime, receiveClientEndTime = 0;
    	//System.out.println("\n DEBUG : Client.run() - starting client sending thread connected");
    	if(this.clientOperation.equals("sending")) {
    		sendClientStartTime = System.currentTimeMillis();
    		this.sendTransactions();
    		sendClientEndTime = System.currentTimeMillis();
    		long totalClientSendTime = sendClientEndTime - sendClientStartTime;
    		System.out.println("\n Terminating client sending thread - Running time "+totalClientSendTime+" milliseconds");
    	}
    		...
    		long totalClientReceiveTime = receiveClientEndTime - receiveClientStartTime;
    		System.out.println("\n Terminating client receiving thread - Running time "+totalClientReceiveTime+" milliseconds.");
