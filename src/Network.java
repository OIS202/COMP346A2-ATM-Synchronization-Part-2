...
public class Network extends Thread {
    ...
    private static Semaphore emptyIn;
    private static Semaphore fullIn;
    private static Semaphore mutexOut;
    private static Semaphore emptyOut;
    private static Semaphore fullOut;
     ...
     */
     Network( )
      { 
         ...
         emptyIn = new Semaphore(maxNbPackets);
         fullIn = new Semaphore(0);
         mutexOut = new Semaphore(1);
         emptyOut = new Semaphore(maxNbPackets);
